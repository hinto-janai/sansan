...
macro_rules! impl_atomic_f {
    (
        ...
        impl $atomic_float {
            ...
            pub(crate) const BITS_0_50: $unsigned = $bits_050;
            ...
            pub(crate) const DEFAULT: Self = Self($atomic_unsigned::new($bits_0));
            ...
            pub(crate) const fn from_bits(bits: $unsigned) -> Self {
            ...
            pub(crate) fn store_bits(&self, bits: $unsigned, ordering: Ordering) {
            ...
            pub(crate) fn load_bits(&self, ordering: Ordering) -> $unsigned {
            ...
            pub(crate) fn fetch_add(&self, val: $float, order: Ordering) -> $float {
            ...
            ///
            /// Other than this not actually being atomic, all other behaviors are the same.
            pub(crate) fn fetch_sub(&self, val: $float, order: Ordering) -> $float {
                self.fetch_update_unwrap(order, |f| f - val)
            }
            ...
            ///
            /// Other than this not actually being atomic, all other behaviors are the same.
            pub(crate) fn fetch_max(&self, val: $float, order: Ordering) -> $float {
            ...
            ///
            /// Other than this not actually being atomic, all other behaviors are the same.
            pub(crate) fn fetch_min(&self, val: $float, order: Ordering) -> $float {
