...
// impl<Extra: ExtraData> someday::ApplyReturn<Signal<Extra>, Shuffle, Option<Source<Extra>>> for AudioState<Extra> {
// 	fn apply_return(s: &mut Shuffle, w: &mut Self, r: &Self) -> Option<Source<Extra>> {
