...
pub(crate) enum AudioStatePatch<QueueData: Clone> {
...
//---------------------------------------------------------------------------------------------------- Apply Impl
impl<QueueData: Clone> Apply<AudioStatePatch<QueueData>> for AudioState<QueueData> {
	#[inline]
	fn apply(patch: &mut AudioStatePatch<QueueData>, writer: &mut Self, _: &Self) {
